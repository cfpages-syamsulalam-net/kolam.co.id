---
article_id: K11-05
title: "UV, Ozon, dan AOP: Sistem Tambahan, Bukan Pengganti Semua Sanitizer"
slug: "uv-ozon-aop-kolam"
description: "Roles, limitations, contact, residual"
status: outline
...
final_route: "/artikel/uv-ozon-aop-kolam.html"
...
# UV, Ozon, dan AOP: Sistem Tambahan, Bukan Pengganti Semua Sanitizer

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “UV, Ozon, dan AOP: Sistem Tambahan, Bukan Pengganti Semua Sanitizer”
...
- **Reader outcome:** Roles, limitations, contact, residual
...
- **Scope boundary:** Vendor claims require evidence
- **Final public route:** `/artikel/uv-ozon-aop-kolam.html`
- **Appointed CMS date:** `2025-03-29` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **UV, Ozon, dan AOP: Sistem Tambahan, Bukan Pengganti Semua Sanitizer**.
...
- **Tie back to this article:** Keep the explanation specific to “UV, Ozon, dan AOP: Sistem Tambahan, Bukan Pengganti Semua Sanitizer”.
