---
article_id: K23-04
title: "Kolam Sekolah: Jadwal, Pengawasan, dan Kualitas Air"
slug: "pengelolaan-kolam-sekolah"
description: "Child groups, lessons, checks, closures"
status: outline
...
final_route: "/artikel/pengelolaan-kolam-sekolah.html"
technical_review: required
sources:
  - "https://pesta.bsn.go.id/produk/detail/12927-sni17272020"
  - "https://pesta.bsn.go.id/produk/detail/9716-sni79732013"
  - "https://pesta.bsn.go.id/produk/detail/12882-sni17292020"
  - "https://pesta.bsn.go.id/produk/index/2?key=2019"
...
# Kolam Sekolah: Jadwal, Pengawasan, dan Kualitas Air

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kolam Sekolah: Jadwal, Pengawasan, dan Kualitas Air”
- **Reader and situation:** hotel, villa, apartment, school, gym, club, therapy, competition, waterpark, occupancy/bather load, staffing, logs, downtime, guest complaints, revenue, insurance
- **Reader outcome:** Child groups, lessons, checks, closures
...
- **Scope boundary:** Safety K15
- **Final public route:** `/artikel/pengelolaan-kolam-sekolah.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kolam Sekolah: Jadwal, Pengawasan, dan Kualitas Air**.
...
- **Original sources:** [SNI 1729:2020 official BSN record](https://pesta.bsn.go.id/produk/detail/12882-sni17292020), [SNI 2847:2019 official BSN catalogue](https://pesta.bsn.go.id/produk/index/2?key=2019), and [SNI 1727:2020](https://pesta.bsn.go.id/produk/detail/12927-sni17272020).
- **Purpose for this article:** Ground non-wood gazebo frames, concrete/masonry supports, reinforcement, welding/bolting, corrosion, cracking, and hybrid interfaces.
- **Safe grounded facts:** Section size, wall thickness, concrete strength label, visible reinforcement, weld appearance, coating name, or hybrid sketch does not establish capacity, stability, durability, fire, interface, or installed conformity.
- **Limits:** Obtain current complete applicable standards, material certificates/tests, exposure, corrosion/crack controls, reinforcement/connection details, welding/bolting qualifications, drawings, calculations, inspection, and engineer acceptance under G-01/G-05/G-06/G-11.
...
- `K23-02` → `/artikel/pengelolaan-kolam-apartemen.html` — Kolam Apartemen: Pembagian Tanggung Jawab Pengelola, Teknisi, dan Vendor
- `K23-03` → `/artikel/bather-load-kolam.html` — Mengelola Bather Load: Mengapa Jumlah Pengguna Mengubah Kebutuhan Sistem
- `K23-05` → `/artikel/operasional-waterpark.html` — Waterpark: Mengelola Banyak Wahana dengan Risiko Berbeda
- `K23-06` → `/artikel/kpi-operasional-kolam-komersial.html` — KPI Kolam Komersial: Bukan Hanya Air Terlihat Bening
...
- **Tie back to this article:** Keep the explanation specific to “Kolam Sekolah: Jadwal, Pengawasan, dan Kualitas Air”.
