---
article_id: K08-03
title: "Menentukan Ukuran Filter Kolam dari Debit, Bukan Tebakan"
slug: "menentukan-ukuran-filter-kolam"
description: "Flow/loading rate method"
status: outline
...
final_route: "/artikel/menentukan-ukuran-filter-kolam.html"
...
# Menentukan Ukuran Filter Kolam dari Debit, Bukan Tebakan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Menentukan Ukuran Filter Kolam dari Debit, Bukan Tebakan”
...
- **Reader outcome:** Flow/loading rate method
...
- **Scope boundary:** Pump sizing K09
- **Final public route:** `/artikel/menentukan-ukuran-filter-kolam.html`
- **Appointed CMS date:** `2025-01-08` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menentukan Ukuran Filter Kolam dari Debit, Bukan Tebakan**.
...
- `K08-01` → `/artikel/cara-kerja-filter-kolam.html` — Cara Kerja Filter Kolam dan Apa yang Tidak Bisa Disaring
- `K08-02` → `/artikel/filter-pasir-vs-cartridge-vs-de.html` — Filter Pasir vs Cartridge vs DE: Kualitas Air dan Beban Perawatan
- `K08-04` → `/artikel/cara-backwash-filter-kolam.html` — Backwash dan Rinse: Kapan, Berapa Lama, dan Mengapa?
...
- **Tie back to this article:** Keep the explanation specific to “Menentukan Ukuran Filter Kolam dari Debit, Bukan Tebakan”.
