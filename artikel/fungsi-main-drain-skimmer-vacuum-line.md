---
article_id: K07-05
title: "Main Drain, Skimmer, dan Vacuum Line: Fungsi yang Tidak Bisa Ditukar"
slug: "fungsi-main-drain-skimmer-vacuum-line"
description: "Suction roles and safety"
status: outline
...
final_route: "/artikel/fungsi-main-drain-skimmer-vacuum-line.html"
...
# Main Drain, Skimmer, dan Vacuum Line: Fungsi yang Tidak Bisa Ditukar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Main Drain, Skimmer, dan Vacuum Line: Fungsi yang Tidak Bisa Ditukar”
...
- **Reader outcome:** Suction roles and safety
...
- **Scope boundary:** Component selection K13
- **Final public route:** `/artikel/fungsi-main-drain-skimmer-vacuum-line.html`
- **Appointed CMS date:** `2024-12-16` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Main Drain, Skimmer, dan Vacuum Line: Fungsi yang Tidak Bisa Ditukar**.
...
- **Tie back to this article:** Keep the explanation specific to “Main Drain, Skimmer, dan Vacuum Line: Fungsi yang Tidak Bisa Ditukar”.
