---
article_id: K12-03
title: "Air Kolam Keruh Setelah Hujan: Periksa dari Beban Kotoran sampai Sirkulasi"
slug: "air-kolam-keruh-setelah-hujan"
description: "Rain-specific cause chain"
status: outline
...
final_route: "/artikel/air-kolam-keruh-setelah-hujan.html"
...
# Air Kolam Keruh Setelah Hujan: Periksa dari Beban Kotoran sampai Sirkulasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Air Kolam Keruh Setelah Hujan: Periksa dari Beban Kotoran sampai Sirkulasi”
- **Reader and situation:** green/mustard/black algae, biofilm, cloudy water, metals, organic staining, scale, pollen/dust, phosphates, prevention, brushing, circulation diagnosis
- **Reader outcome:** Rain-specific cause chain
...
- **Scope boundary:** General cloudiness K12-04
- **Final public route:** `/artikel/air-kolam-keruh-setelah-hujan.html`
- **Appointed CMS date:** `2025-04-16` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Air Kolam Keruh Setelah Hujan: Periksa dari Beban Kotoran sampai Sirkulasi**.
...
- `/artikel/beberapa-cara-menghilangkan-kotoran-air-kolam-renang` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `K12-01` → `/artikel/penyebab-air-kolam-hijau.html` — Kolam Hijau: Bedakan Alga, Logam, dan Gangguan Filtrasi
- `K12-02` → `/artikel/jenis-alga-kolam.html` — Alga Hijau, Mustard, dan Hitam: Mengapa Penanganannya Berbeda?
- `K12-04` → `/artikel/air-kolam-putih-keruh.html` — Air Kolam Putih Keruh: Partikel, Presipitasi, atau Gelembung Mikro?
- `K12-05` → `/artikel/diagnosis-noda-kolam.html` — Noda Cokelat, Hijau, atau Hitam pada Kolam: Logam atau Organik?
...
- **Tie back to this article:** Keep the explanation specific to “Air Kolam Keruh Setelah Hujan: Periksa dari Beban Kotoran sampai Sirkulasi”.
