---
article_id: K07-04
title: "Penempatan Inlet agar Tidak Ada Zona Air Mati"
slug: "penempatan-inlet-kolam"
description: "Jet direction, geometry, wind, testing"
status: outline
...
final_route: "/artikel/penempatan-inlet-kolam.html"
...
# Penempatan Inlet agar Tidak Ada Zona Air Mati

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Penempatan Inlet agar Tidak Ada Zona Air Mati”
- **Reader and situation:** turnover, flow rate, velocity, head loss, pipe sizing, suction/return balance, inlet placement, dead zones, skimmer, overflow gutter, balance tank, main drains, vacuum lines, air locks, water hammer
- **Reader outcome:** Jet direction, geometry, wind, testing
...
- **Scope boundary:** Existing inlet article should merge
- **Final public route:** `/artikel/penempatan-inlet-kolam.html`
- **Appointed CMS date:** `2024-12-11` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Penempatan Inlet agar Tidak Ada Zona Air Mati**.
...
- `K07-02` → `/artikel/menghitung-debit-sirkulasi-kolam.html` — Cara Menghitung Debit Sirkulasi Kolam dari Volume dan Waktu Turnover
- `K07-03` → `/artikel/menentukan-ukuran-pipa-kolam.html` — Ukuran Pipa Kolam: Menghubungkan Debit, Kecepatan, dan Head Loss
- `K07-05` → `/artikel/fungsi-main-drain-skimmer-vacuum-line.html` — Main Drain, Skimmer, dan Vacuum Line: Fungsi yang Tidak Bisa Ditukar
- `K07-06` → `/artikel/menghitung-balance-tank-kolam.html` — Balance Tank Kolam Overflow: Fungsi dan Faktor Penentu Kapasitas
...
- **Tie back to this article:** Keep the explanation specific to “Penempatan Inlet agar Tidak Ada Zona Air Mati”.
