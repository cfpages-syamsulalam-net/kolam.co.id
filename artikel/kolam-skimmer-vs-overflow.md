---
article_id: K00-04
title: "Kolam Skimmer vs Overflow: Perbedaan Sistem, Ruang, dan Biaya"
slug: "kolam-skimmer-vs-overflow"
description: "Hydraulic/architectural decision"
status: outline
...
final_route: "/artikel/kolam-skimmer-vs-overflow.html"
...
# Kolam Skimmer vs Overflow: Perbedaan Sistem, Ruang, dan Biaya

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kolam Skimmer vs Overflow: Perbedaan Sistem, Ruang, dan Biaya”
- **Reader and situation:** pool anatomy, system diagram, circulation path, glossary, units, indoor/outdoor, in-ground/above-ground, skimmer/overflow, freshwater/saltwater
- **Reader outcome:** Hydraulic/architectural decision
...
- **Scope boundary:** Balance-tank sizing belongs K07-06
- **Final public route:** `/artikel/kolam-skimmer-vs-overflow.html`
- **Appointed CMS date:** `2024-05-29` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kolam Skimmer vs Overflow: Perbedaan Sistem, Ruang, dan Biaya**.
...
- `K00-02` → `/artikel/cara-kerja-sistem-kolam-renang.html` — Cara Kerja Sistem Kolam Renang dalam Satu Siklus Lengkap
- `K00-03` → `/artikel/kamus-istilah-kolam-renang.html` — Kamus Kolam Renang: 100 Istilah yang Perlu Dipahami Pemilik
- `K00-05` → `/artikel/kolam-in-ground-vs-above-ground.html` — Kolam In-Ground vs Above-Ground: Mana yang Cocok untuk Lahan Anda?
- `K00-06` → `/artikel/kolam-air-tawar-vs-saltwater.html` — Kolam Air Tawar vs Saltwater: Apa yang Sebenarnya Berbeda?
...
- **Tie back to this article:** Keep the explanation specific to “Kolam Skimmer vs Overflow: Perbedaan Sistem, Ruang, dan Biaya”.
