---
article_id: K15-03
title: "Lantai Anti-Slip di Area Kolam: Cara Membaca Klasifikasi"
slug: "lantai-anti-slip-area-kolam"
description: "Test classes, wet use, cleaning"
status: outline
...
final_route: "/artikel/lantai-anti-slip-area-kolam.html"
...
# Lantai Anti-Slip di Area Kolam: Cara Membaca Klasifikasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lantai Anti-Slip di Area Kolam: Cara Membaca Klasifikasi”
...
- **Reader outcome:** Test classes, wet use, cleaning
...
- **Scope boundary:** Deck materials K22
- **Final public route:** `/artikel/lantai-anti-slip-area-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lantai Anti-Slip di Area Kolam: Cara Membaca Klasifikasi**.
...
- `K15-01` → `/artikel/keamanan-kolam-rumah-untuk-anak.html` — Checklist Keamanan Kolam Rumah untuk Anak
- `K15-02` → `/artikel/panduan-pagar-kolam.html` — Pagar Kolam: Tinggi, Celah, Gerbang, dan Kesalahan Desain
- `K15-04` → `/artikel/penanda-kedalaman-kolam.html` — Penanda Kedalaman Kolam: Kecil Bentuknya, Besar Fungsinya
...
- **Tie back to this article:** Keep the explanation specific to “Lantai Anti-Slip di Area Kolam: Cara Membaca Klasifikasi”.
