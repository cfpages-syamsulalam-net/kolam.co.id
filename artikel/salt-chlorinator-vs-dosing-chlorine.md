---
article_id: K11-04
title: "Salt Chlorinator vs Dosing Chlorine: Pengalaman Pengguna dan Perawatan"
slug: "salt-chlorinator-vs-dosing-chlorine"
description: "Equipment, salt, byproducts, cost"
status: outline
...
final_route: "/artikel/salt-chlorinator-vs-dosing-chlorine.html"
...
# Salt Chlorinator vs Dosing Chlorine: Pengalaman Pengguna dan Perawatan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Salt Chlorinator vs Dosing Chlorine: Pengalaman Pengguna dan Perawatan”
- **Reader and situation:** chlorine forms, free/combined chlorine, chloramines, breakpoint, salt chlorination, bromine, UV, ozone, AOP, bacteria, viruses, protozoa, swimmer hygiene, public-pool response
- **Reader outcome:** Equipment, salt, byproducts, cost
...
- **Scope boundary:** Freshwater/saltwater overview K00-06
- **Final public route:** `/artikel/salt-chlorinator-vs-dosing-chlorine.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Salt Chlorinator vs Dosing Chlorine: Pengalaman Pengguna dan Perawatan**.
...
- `K11-02` → `/artikel/chloramine-kolam.html` — Chloramine: Mengapa Bau “Kaporit” Bisa Berarti Sanitasi Bermasalah
- `K11-03` → `/artikel/breakpoint-chlorination-kolam.html` — Breakpoint Chlorination: Konsep, Perhitungan, dan Risiko Salah Pakai
- `K11-05` → `/artikel/uv-ozon-aop-kolam.html` — UV, Ozon, dan AOP: Sistem Tambahan, Bukan Pengganti Semua Sanitizer
- `K11-06` → `/artikel/respons-kontaminasi-kolam.html` — Apa yang Harus Dilakukan Setelah Kontaminasi Feses atau Muntahan di Kolam?
...
- **Tie back to this article:** Keep the explanation specific to “Salt Chlorinator vs Dosing Chlorine: Pengalaman Pengguna dan Perawatan”.
