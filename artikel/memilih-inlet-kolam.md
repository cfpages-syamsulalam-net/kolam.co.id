---
article_id: K13-03
title: "Inlet Kolam: Model Eyeball, Arah Aliran, dan Kemudahan Servis"
slug: "memilih-inlet-kolam"
description: "Fitting selection"
status: outline
...
final_route: "/artikel/memilih-inlet-kolam.html"
...
# Inlet Kolam: Model Eyeball, Arah Aliran, dan Kemudahan Servis

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Inlet Kolam: Model Eyeball, Arah Aliran, dan Kemudahan Servis”
...
- **Reader outcome:** Fitting selection
...
- **Scope boundary:** Placement hydraulics K07-04
- **Final public route:** `/artikel/memilih-inlet-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Inlet Kolam: Model Eyeball, Arah Aliran, dan Kemudahan Servis**.
...
- `K13-01` → `/artikel/memilih-skimmer-kolam.html` — Skimmer Kolam: Jumlah, Posisi, dan Pengaruh Angin
- `K13-02` → `/artikel/main-drain-dan-risiko-entrapment.html` — Main Drain Kolam dan Risiko Entrapment
- `K13-04` → `/artikel/jenis-valve-ruang-mesin-kolam.html` — Valve Ruang Mesin: Ball, Butterfly, Check, dan Multiport
...
- **Tie back to this article:** Keep the explanation specific to “Inlet Kolam: Model Eyeball, Arah Aliran, dan Kemudahan Servis”.
