---
article_id: K03-04
title: "Mengapa Dasar Kolam Dibuat Miring? Fungsi Slope dan Titik Transisi"
slug: "kemiringan-dasar-kolam"
description: "Drainage myth, user movement, construction"
status: outline
...
final_route: "/artikel/kemiringan-dasar-kolam.html"
...
# Mengapa Dasar Kolam Dibuat Miring? Fungsi Slope dan Titik Transisi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mengapa Dasar Kolam Dibuat Miring? Fungsi Slope dan Titik Transisi”
- **Reader and situation:** Olympic dimensions, lane widths, depths, slopes, transitions, freeboard, steps, ladders, benches, ledges, gutters, beach entry, turning walls, diving zones
- **Reader outcome:** Drainage myth, user movement, construction
...
- **Scope boundary:** Main-drain hydraulics separate
- **Final public route:** `/artikel/kemiringan-dasar-kolam.html`
- **Appointed CMS date:** `2024-09-09` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengapa Dasar Kolam Dibuat Miring? Fungsi Slope dan Titik Transisi**.
...
- `K03-02` → `/artikel/menentukan-ukuran-kolam-rumah.html` — Cara Menentukan Panjang dan Lebar Kolam Renang Rumah
- `K03-03` → `/artikel/menentukan-kedalaman-kolam.html` — Kedalaman Kolam Renang Berdasarkan Aktivitas Pengguna
- `K03-05` → `/artikel/desain-tangga-kolam.html` — Tangga Kolam: Dimensi, Posisi, dan Kesalahan yang Sulit Diperbaiki
- `K03-06` → `/artikel/desain-sun-ledge-dan-bangku-kolam.html` — Baja Shelf, Sun Ledge, dan Bangku Kolam: Berapa Ruang yang Dibutuhkan?
...
- **Tie back to this article:** Keep the explanation specific to “Mengapa Dasar Kolam Dibuat Miring? Fungsi Slope dan Titik Transisi”.
