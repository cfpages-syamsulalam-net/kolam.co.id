---
article_id: K22-04
title: "Tanaman di Sekitar Kolam: Akar, Daun, Serangga, dan Ketahanan"
slug: "memilih-tanaman-sekitar-kolam"
description: "Plant traits, setbacks, maintenance"
status: outline
...
final_route: "/artikel/memilih-tanaman-sekitar-kolam.html"
...
# Tanaman di Sekitar Kolam: Akar, Daun, Serangga, dan Ketahanan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tanaman di Sekitar Kolam: Akar, Daun, Serangga, dan Ketahanan”
...
- **Reader outcome:** Plant traits, setbacks, maintenance
...
- **Scope boundary:** Detailed horticulture links taman.co.id
- **Final public route:** `/artikel/memilih-tanaman-sekitar-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tanaman di Sekitar Kolam: Akar, Daun, Serangga, dan Ketahanan**.
...
- `K22-02` → `/artikel/drainase-area-kolam.html` — Drainase Area Kolam agar Air Hujan Tidak Masuk ke Kolam
- `K22-03` → `/artikel/pilihan-naungan-area-kolam.html` — Naungan Kolam: Pergola, Kanopi, Pohon, atau Payung?
- `K22-05` → `/artikel/outdoor-shower-area-kolam.html` — Outdoor Shower dan Foot Bath: Kecil tetapi Berpengaruh pada Air Kolam
...
- **Tie back to this article:** Keep the explanation specific to “Tanaman di Sekitar Kolam: Akar, Daun, Serangga, dan Ketahanan”.
