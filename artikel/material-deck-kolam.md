---
article_id: K22-01
title: "Material Deck Kolam: Batu, Keramik, Kayu, WPC, atau Beton"
slug: "material-deck-kolam"
description: "Heat, slip, drainage, joints, maintenance"
status: outline
...
final_route: "/artikel/material-deck-kolam.html"
...
# Material Deck Kolam: Batu, Keramik, Kayu, WPC, atau Beton

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Material Deck Kolam: Batu, Keramik, Kayu, WPC, atau Beton”
...
- **Reader outcome:** Heat, slip, drainage, joints, maintenance
...
- **Scope boundary:** Anti-slip standards K15
- **Final public route:** `/artikel/material-deck-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Material Deck Kolam: Batu, Keramik, Kayu, WPC, atau Beton**.
...
- `/renovasi-kolam-renang-batu.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/renovasi-kolam-renang-batu` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/perawatan-kolam-renang-batu.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/perawatan-kolam-renang-batu` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kolam-renang-rumah-batu.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kolam-renang-rumah-batu` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Material Deck Kolam: Batu, Keramik, Kayu, WPC, atau Beton”.
