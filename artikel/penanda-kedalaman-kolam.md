---
article_id: K15-04
title: "Penanda Kedalaman Kolam: Kecil Bentuknya, Besar Fungsinya"
slug: "penanda-kedalaman-kolam"
description: "Placement/visibility/user behavior"
status: outline
...
final_route: "/artikel/penanda-kedalaman-kolam.html"
...
# Penanda Kedalaman Kolam: Kecil Bentuknya, Besar Fungsinya

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Penanda Kedalaman Kolam: Kecil Bentuknya, Besar Fungsinya”
- **Reader and situation:** barriers, covers, alarms, anti-entrapment, depth markers, slip resistance, lighting, rescue equipment, child safety, accessibility, staff supervision, weather/lightning
- **Reader outcome:** Placement/visibility/user behavior
...
- **Scope boundary:** Standards require current citation
- **Final public route:** `/artikel/penanda-kedalaman-kolam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Penanda Kedalaman Kolam: Kecil Bentuknya, Besar Fungsinya**.
...
- `K15-02` → `/artikel/panduan-pagar-kolam.html` — Pagar Kolam: Tinggi, Celah, Gerbang, dan Kesalahan Desain
- `K15-03` → `/artikel/lantai-anti-slip-area-kolam.html` — Lantai Anti-Slip di Area Kolam: Cara Membaca Klasifikasi
- `K15-05` → `/artikel/peralatan-rescue-kolam.html` — Peralatan Rescue Kolam dan Kapan Staf Harus Dilatih
- `K15-06` → `/artikel/aksesibilitas-kolam.html` — Merancang Akses Kolam untuk Lansia dan Pengguna Disabilitas
...
- **Tie back to this article:** Keep the explanation specific to “Penanda Kedalaman Kolam: Kecil Bentuknya, Besar Fungsinya”.
